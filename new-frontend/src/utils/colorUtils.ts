 ...
 *
 * @param nodeType - The type of the node (e.g., 'agent', 'python', 'custom')
 * @returns CSS variable overrides for the node
 */
export function getNodeStyles(nodeType: string): Record<string, string> {
  if (!nodeType) return {};
